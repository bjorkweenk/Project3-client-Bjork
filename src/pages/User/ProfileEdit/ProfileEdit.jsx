...
<br></br>
  ...
  <div class="form-group">
    ...
    <textarea type="tagline" class="form-control" id="Tagline" placeholder="Tagline" rows="2"></textarea>
  </div>
  
  <br></br>
  <a href="/profile/{id}"> <button type="submit" class="btn btn-primary">Confirm</button> </a>
</form>

<br></br>
<a href="/profile/:id"><button type="button" class="btn btn-primary"> go back </button></a>
